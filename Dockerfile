FROM rocker/geospatial:4.0.5@sha256:edfbef4392d71ca0d1ab97a1d894f6d73e6ec8eb7c960b715876719848009ed7
...
RUN set -x && \
  ...
  install2.r --error --ncpus -1 --repos 'https://cran.microsoft.com/snapshot/2021-02-24/' \
    assertr \
    bench \
    classInt \
    colormap \
