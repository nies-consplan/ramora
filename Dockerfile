FROM rocker/geospatial:4.0.3@sha256:08fe1013f9044ba87826c00e6d24e719e8fbc7330f655dea8e379585aeeec730
...
RUN set -x && \
  ...
  install2.r --error --ncpus -1 --repos 'https://cran.microsoft.com/snapshot/2021-02-11/' \
    assertr \
    bench \
    classInt \
    colormap \
